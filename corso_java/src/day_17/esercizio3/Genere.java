...
/**
 * Rappresenta un Genere musicale, definito principalmente dal suo nome.
...
public class Genere {
	...
	// Campo privato per memorizzare il nome del genere musicale.
	private String nome;
	
	/**
	 * Costruttore di default (senza argomenti).
	 * Permette di creare un'istanza vuota di Genere.
	 */
	public Genere() {
	 ...
	 * Crea un oggetto Genere inizializzando subito il suo nome.
	 * @param aNome Il nome da assegnare al genere.
	 */
	public Genere(String aNome) {
	...
	/**
	 * Imposta o modifica il nome del genere.
	 ...
	 * Definisce la logica di uguaglianza: due oggetti Genere sono considerati uguali
	 ...
	 * @return una stringa formattata con i dettagli del genere.
	 */
	@Override
